...
assertEqual(solve(copy(test), 8), [1])
assertEqual(solve(copy(test), 9), [0])
assertEqual(solve(copy(test), 0), [0])
...
assertEqual(solve(copy(test), 8), [0])
assertEqual(solve(copy(test), 9), [0])
assertEqual(solve(copy(test), 0), [1])
assertEqual(solve(copy(test), 7), [1])
...
assertEqual(solve(copy(test), 8), [1])
assertEqual(solve(copy(test), 9), [1])
assertEqual(solve(copy(test), 0), [0])
assertEqual(solve(copy(test), 1), [1])
